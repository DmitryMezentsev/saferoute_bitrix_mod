...
$MESS['SAFEROUTE_WIDGET_CASH_ON_DELIVERY_VARIANT'] = 'Payment on receipt option (for use with acquiring via widget)';
$MESS['SAFEROUTE_WIDGET_NOT_SELECTED']             = 'Not selected';
